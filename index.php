		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="collpase-bar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="https://www.cnovv.com" target="_blank">极致资源网</a></li>
					<li class="nav-item"><a class="nav-link" href="https://www.acmeyun.com" target="_blank">免费主机</a></li>
				</ul>
			</div>
		</div>
	</nav>
